...
local mainMod = "SUPER + "
local meh = "SUPER + ALT + SHIFT + CTRL + "
...
hl.bind(meh .. "C", hl.dsp.exec_cmd("hyprpicker --autocopy --format=hex"))
hl.bind(meh .. "Q", hl.dsp.exit())
...
hl.bind(meh .. "H", hl.dsp.workspace.toggle_special("hidden"))
...
require("hosts.tuxedo.workspaces")
